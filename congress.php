...
// define variables and set to empty values
    ...
    if($dbType == "legislators" ) {
        ...
        $url = "http://104.198.0.197:8080/bills?history.active={$_GET['activeStatus']}&last_version.urls.pdf__exists=true&order=introduced_on&per_page=50&apikey=1d4e5439054e4043a9db003f419da734";
